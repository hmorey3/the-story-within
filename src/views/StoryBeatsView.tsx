...
export function StoryBeatsView({ story, onBack, onOpenEditor, onAddBeat, onEditCover }: StoryBeatsViewProps) {
      ...
      <header className="story-view__hero">
        ...
        <div>
          ...
          <div className="story-view__actions">
            ...
            <button type="button" className="secondary" onClick={onEditCover}>
              Edit cover
            </button>
          </div>
